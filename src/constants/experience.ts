export const experience = [
  ...
  },
  {
    ...
    date: "Nov/2021 - Mai/2022",
    src: "/experience/supera.jpg",
    projects: [
      "Daexe (Projeto) e Liver (Projeto): Responsável pela criação componentes usando React e React Native",
      "Bristom (Projeto): Responsável pela criação de componentes, montagem de telas e correção de bugs, nesse projeto trabalhei com React, React Native e Node.js com Sequelize",
      "Algar (Projeto): Responsável pela implementação de regras de negócio, criação de componentes e montagem de telas, nesse projeto usei React Native e Redux",
